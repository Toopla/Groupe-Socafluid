        ...
        submitSuccess: function($form, event) {
            ...
            $.ajax({
                ...
                error: function() {
                    ...
                    $('#success > .alert-danger').append("<strong>Désolé " + firstName + ", Il semble que notre serveur de mail ne répond pas. Merci de Re essayer plus tard.");
